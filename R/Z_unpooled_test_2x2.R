Z_unpooled_test_2x2 = function(n, printresults=T) {

    # function [P, Z] = Z_unpooled_test_2x2(n, printresults)
    ...
    if (printresults) {
        print(sprintf('The Z-unpooled test: P = %7.5f, Z = %6.3f', P, Z), quote=F)
    }
