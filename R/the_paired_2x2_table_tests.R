...
source(paste(path, "McNemar_asymptotic_test_paired_2x2.R", sep="/"))
source(paste(path, "McNemar_asymptotic_test_CC_paired_2x2.R", sep="/"))
source(paste(path, "McNemar_exact_cond_test_paired_2x2.R", sep="/"))
source(paste(path, "McNemar_midP_test_paired_2x2.R", sep="/"))
source(paste(path, "McNemar_exact_unconditional_test_paired_2x2.R", sep="/"))
source(paste(path, "ClopperPearson_exact_CI_1x2_beta_version.R", sep="/"))
