MiettinenNurminen_asymptotic_score_CI_difference_2x2 = function(n, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = MiettinenNurminen_asymptotic_score_CI_difference_2x2(n, alpha, printresults)
    # The Mietinen-Nurminen asymptotic score confidence interval for the
