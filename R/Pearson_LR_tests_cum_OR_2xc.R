Pearson_LR_tests_cum_OR_2xc = function(n, direction, printresults=T) {
	...
	# direction: the direction of column probabilities ("increasing" or "decreasing")
	...
	if (printresults) {
	    print(sprintf('Pearson chi-squared test: T = %6.3f,  P = %7.5f', T_Pearson, P_Pearson), quote=F)
	    print(sprintf('Likelihood ratio test:    T = %6.3f,  P = %7.5f', T_LR, P_LR), quote=F)
	}
