# function [P, T, df] = FisherFreemanHalton_asymptotic_test_rxc(n, printresults)
	
FisherFreemanHalton_asymptotic_test_rxc = function(n, printresults=T) {
	...
	if (missing(n)) {
	    n = rbind(c(40,25),c(54,7),c(63,10)) # Treatment for ear infection (van Balen et al., 2003)
	}
	...
	# gamma: the normalizing constant
