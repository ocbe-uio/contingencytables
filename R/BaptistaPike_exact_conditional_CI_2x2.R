BaptistaPike_exact_conditional_CI_2x2 = function(n, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = BaptistaPike_exact_conditional_CI_2x2(n, alpha, printresults)
    ...
    if (printresults) {
        print(sprintf('Baptista-Pike exact conditional CI: estimate = %6.4f (%g%% CI %6.4f to %6.4f)', 
