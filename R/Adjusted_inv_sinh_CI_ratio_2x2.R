Adjusted_inv_sinh_CI_ratio_2x2 = function(n, psi1=0, psi2=0, psi3=0, psi4=1, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = Adjusted_inv_sinh_CI_ratio_2x2(n, psi1, psi2, psi3, psi4, alpha, printresults)
    ...
    # psi1, psi2, psi3, psi4: pseudo-frequencies
