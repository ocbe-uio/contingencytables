 Wald_test_and_CI_marginal_mean_scores_paired_cxc = function(n, a, alpha=0.05, printresults=T) {
 	...
 	if (missing(n) || missing(a)) {
		...
		a = c(8, 3.5, 0, -3.5, -8)
 		# n = [1 0 1 0 0; 0 2 8 4 4; 1 1 31 14 11; 1 0 15 9 12; 0 0 2 1 3]; a = [1.5, 3, 4, 5, 6.5]
 	}
