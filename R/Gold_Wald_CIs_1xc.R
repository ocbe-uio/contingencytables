Gold_Wald_CIs_1xc = function(n, alpha=0.05, printresults=T) {

    # function [L, U, pihat] = Gold_Wald_CIs_1xc(n, alpha, printresults)
    ...
    if (printresults) {
        print(sprintf('The Gold Wald simultaneous intervals'), quote=F)
        for (i in 1:c0) {
