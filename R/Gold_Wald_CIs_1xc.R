#' @title The Gold Wald simultaneous intervals for the multinomial probabilities
#' @description The Gold Wald simultaneous intervals for the multinomial probabilities (with Scheffe adjustment)
...
Gold_Wald_CIs_1xc <- function(n, alpha = 0.05) {
  ...
  printresults <- function() {
    cat("The Gold Wald simultaneous intervals\n ")
