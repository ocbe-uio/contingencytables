...
source(paste(path, "Wald_CI_diff_paired_2x2.R", sep="/"))
source(paste(path, "Wald_CI_diff_CC_paired_2x2.R", sep="/"))
source(paste(path, "Wald_CI_AgrestiMin_paired_2x2.R", sep="/"))
source(paste(path, "Wald_CI_BonettPrice_paired_2x2.R", sep="/"))
source(paste(path, "Newcombe_square_and_add_CI_paired_2x2.R", sep="/"))
source(paste(path, "Tango_asymptotic_score_CI_paired_2x2.R", sep="/"))
