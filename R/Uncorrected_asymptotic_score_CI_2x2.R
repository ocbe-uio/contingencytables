Uncorrected_asymptotic_score_CI_2x2 = function(n, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = Uncorrected_asymptotic_score_CI_2x2(n, alpha, printresults)
