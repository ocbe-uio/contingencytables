# function [P, Z] = JonckheereTerpstra_test_rxc(n, printresults)

JonckheereTerpstra_test_rxc = function(n, printresults=T) {
	...
	if (printresults) {
	    print(sprintf('The Jonckheere-Terpstra test for association: P = %8.6f, Z = %6.3f', P, Z), quote=F)
	}
