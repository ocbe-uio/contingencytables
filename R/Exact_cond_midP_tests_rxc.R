# function results = Exact_cond_midP_tests_rxc(n, printresults)

Exact_cond_midP_tests_rxc = function(n, printresults=T) {

	# Exact conditional and mid-P tests for the rxc table: the Fisher-Freeman-Halton, Pearson, 
	# likelihood ratio, Kruskal-Wallis, linear-by-linear, and Jonckheere-Terpstra tests
	#
	...
	if (missing(n)) {
	    n = rbind(c(40, 25), c(54, 7), c(63, 10))  # Treatment for ear infection (Table 7.3)
		# n = [22 4 12; 24 9 10; 51 7 6]; # Low birth weight vs psychiatric morbitidy (Table 7.6)
	}
	...
	if (r == 3 && c == 2) {
	    ...
	    print(sprintf('Too elaborate...'), quote=F)
	    return
	}
...
# ==================================================
# function tables = find_possible_tables_3x2(nip, npj)
...
# ==================================================
# function tables = find_possible_tables_3x3(nip, npj)
...
# ==========================================================================================
# function [T_FFH, T_Pearson, T_LR, T_KW, T_lbl, T_JT] = test_statistics(x, N, r, c, nip, npj)
...
# ======================================================================
# function [T_Pearson, T_LR] = Pearson_LR_statistics(x, N, r, c, nip, npj)
...
# ========================================================
# function T = KruskalWallis_statistic(x, N, r, c, nip, npj)
...
# =================================================
# function T = linear_by_linear_statistic(x, N, r, c)
...
# ======================================================
# function T = Jonckheere_Terpstra_statistic(x, r, c, nip)
...
# ===========================================================
# function f = multiple_hypergeomtric_pdf(x, N, r, c, nip, npj)
