 Wald_test_and_CI_common_diff_stratified_2x2 = function(n, estimatetype="MH", alpha=0.05, printresults=T) {
 	...
 	# Dependencies
 	# ------------
 	# "MantelHaenszel_estimate_stratified_2x2.R"
 	# "InverseVariance_estimate_stratified_2x2.R"
 	#
 	# Input arguments
 	# ---------------
