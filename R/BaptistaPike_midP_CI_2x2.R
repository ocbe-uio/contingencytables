BaptistaPike_midP_CI_2x2 = function(n, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = BaptistaPike_midP_CI_2x2(n, alpha, printresults)
    ...
    # if exitflag ~= 1, display_warning(exitflag), end
    ...
    if (printresults) {
        print(sprintf('Baptista-Pike mid-P CI: estimate = %6.4f (%g%% CI %6.4f to %6.4f)', 
