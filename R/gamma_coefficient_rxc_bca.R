# function [gamma, L, U] = gamma_coefficient_rxc_bca(n, nboot, alpha, printresults)

library(boot)

gamma_coefficient_rxc_bca = function(n, nboot=10000, alpha=0.05, printresults=T) {
...
f.gcrb = function(dat, d) {
	...
	res = gamma_coefficient_rxc(n, printresults=F)
	return(res$gamma)
}
