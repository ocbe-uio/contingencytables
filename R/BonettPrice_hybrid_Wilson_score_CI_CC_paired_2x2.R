 BonettPrice_hybrid_Wilson_score_CI_CC_paired_2x2 = function(n, alpha=0.05, printresults=T) {
 	...
 	if (printresults) {
     .print('The Bonett-Price hybrid Wilson score CI w/CC: estimate = %6.4f (%g%% CI %6.4f to %6.4f)\n', estimate, 100*(1 - alpha), L, U)
 	}
