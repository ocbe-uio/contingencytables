Score_test_CC_1x2 = function(X, n, pi0, printresults=T) {

    # The score test with continuity correction for the binomial probability (pi)
    ...
    if (printresults) {
        print(sprintf('The score test with continuity correction: P = %7.5f, Z = %5.3f', P, Z))
    }
