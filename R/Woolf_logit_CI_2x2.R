Woolf_logit_CI_2x2 = function(n, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = Woolf_logit_CI_2x2(n, alpha, printresults)
    ...
    if (printresults) {
        print(sprintf('The Woolf logit CI: estimate = %6.4f (%g%% CI %6.4f to %6.4f)', 
