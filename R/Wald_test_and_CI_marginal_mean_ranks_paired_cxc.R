Wald_test_and_CI_marginal_mean_ranks_paired_cxc = function(n, alpha=0.05, printresults=T) {
 	...
 	# Also possible: alphahat = (tauhat + 1)/2
 	...
 	# Also possible: CI_alpha = [(CI_tau[1] + 1)/2, (CI_tau[2] + 1)/2]
