...
Mee_asymptotic_score_CI_2x2 <- function(n, alpha=0.05, printresults=TRUE) {
	...
	if (estimate == -1) {
		...
		L <- uniroot(
			calculate_limit_lower, c(delta0, estimate), n11=n11, n21=n21,
	...
	if (estimate == 1) {
		...
		U <- uniroot(
			calculate_limit_upper, c(estimate, delta1), n11=n11, n21=n21,
...
# ==================================
calculate_limit_lower <- function(delta0, n11, n21, n1p, n2p, pi1hat, pi2hat,
									alpha)
{
...
# ==================================
calculate_limit_upper <- function(delta0, n11, n21, n1p, n2p, pi1hat, pi2hat,
									alpha)
{
	# global n11 n21 n1p n2p alphaglobal pi1hat pi2hat limit
	ml.res = ML_estimates(n11, n21, n1p, n2p, delta0)
