#' @title The Cornfield mid-P confidence interval for the odds ratio
#' @description The Cornfield mid-P confidence interval for the odds ratio
...
#' @export
Cornfield_midP_CI_2x2 <- function(n, alpha = 0.05) {
  ...
  printresults <- function() {
    cat_sprintf(
      "Cornfield mid-P CI: estimate = %6.4f (%g%% CI %6.4f to %6.4f)",
