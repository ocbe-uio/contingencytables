Goodman_Wald_CIs_1xc = function(n, alpha=0.05, printresults=T) {

    # function [L, U, pihat] = Goodman_Wald_CIs_1xc(n, alpha, printresults)
    ...
    if (printresults) {
        print(sprintf('The Goodman Wald simultaneous intervals'), quote=F)
        for (i in 1:c0) {
