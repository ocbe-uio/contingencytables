 KruskalWallis_asymptotic_test_rxc = function(n, printresults=T) {
 	...
 	if (missing(n)) {
 	    n = rbind(c(22,4,12),c(24,9,10),c(51,7,6)) # Low birth weight vs psychiatric morbitidy (Table 7.6)
 	#    n = [3 55 23; 8 102 36; 6 14 1; 5, 21, 12; 19 130 64; 7 26 18]; # Psychiatric diag. vs BMI (Table 7.5)
 	}
