PriceBonett_approximate_Bayes_CI_2x2 = function(n, a=1.25, b=2.5, alpha=0.05, printresults=T) {

    # function [L, U, estimate] = PriceBonett_approximate_Bayes_CI_2x2(n, a, b, alpha, printresults)
