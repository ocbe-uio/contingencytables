MidP_multinomial_test_1xc = function(n, pi0, printresults=T) {

    # function P = MidP_multinomial_test_1xc(n, pi0, printresults)
    ...
    if (printresults) {
        print(sprintf('The mid-P multinomial test: P = %7.5f', P), quote=F)
    }
