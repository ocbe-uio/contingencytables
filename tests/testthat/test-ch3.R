...
test_that("Chapter 3 functions basically work", {
  expect_output(
    object = Chacko_test_1xc(n = hypothetical),
  ...
  expect_output(
    object = Gold_Wald_CIs_1xc(n = snp6498169$complete$n),
    regexp = "pi_3: estimate = 0.1525 \\(0.1208 to 0.1841\\)"
  )
  expect_output(
    object = Goodman_Wald_CIs_1xc(n = snp6498169$complete$n),
    regexp = "pi_3: estimate = 0.1525 \\(0.1215 to 0.1834\\)"
  )
  expect_output(
    object = Goodman_Wald_CIs_for_diffs_1xc(n = snp6498169$complete$n),
    regexp = "pi_2 - pi_3: estimate = 0.3385 \\(0.2759 to 0.4011\\)"
  )
  expect_output(
    object = Goodman_Wilson_score_CIs_1xc(n = snp6498169$complete$n),
    regexp = "pi_3: estimate = 0.1525 \\(0.1241 to 0.1859\\)"
  )
  expect_output(
    object = LR_test_1xc(n = snp6498169$subset$n, pi0 = snp6498169$subset$pi0),
  ...
  expect_output(
    object = QuesenberryHurst_Wilson_score_CIs_1xc(n = snp6498169$complete$n),
    regexp = "pi_2: estimate = 0.4910 \\(0.4472 to 0.5348\\)"
  )
  expect_output(
    object = the_1xc_table_CIs(n = snp6498169$complete$n),
