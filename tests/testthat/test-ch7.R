...
test_that("Chapter 7 functions basically work", {
	...
	expect_output(
		object = {set.seed(1562); gamma_coefficient_rxc_bca(n3_short)},
	...
	expect_output(
		object = {set.seed(1562); Kendalls_tau_b_rxc_bca(n3_short)},
	...
	expect_output(
		object = {set.seed(1562); Pearson_correlation_coefficient_rxc_bca(n3_short)},
	...
	expect_output(
		object = {set.seed(562); Spearman_correlation_coefficient_rxc_bca(n3_short)},
