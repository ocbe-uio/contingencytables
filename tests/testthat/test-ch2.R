...
test_that("Chapter 2 functions basically work", {
  ...
  expect_output(
    object = ClopperPearson_midP_CI_1x2(ligarden_2010["X"], ligarden_2010["n"]),
  ...
  expect_output(
    object = Jeffreys_CI_1x2(ligarden_2010["X"], ligarden_2010["n"]),
    regexp = "estimate = 0.8125 \\(95% CI 0.5792 to 0.9442\\)"
  )
  expect_error(LR_CI_1x2(100))
  expect_output(
    object = LR_CI_1x2(ligarden_2010["X"], ligarden_2010["n"]),
    regexp = "estimate = 0.8125 \\(95% CI 0.5828 to 0.9497\\)"
  )
  expect_error(LR_test_1x2(100))
  expect_output(
    object = LR_test_1x2(ligarden_2010["X"], ligarden_2010["n"], pi0 = .5),
  ...
  expect_output(
    object = Score_test_1x2(ligarden_2010["X"], ligarden_2010["n"], pi0 = .5),
