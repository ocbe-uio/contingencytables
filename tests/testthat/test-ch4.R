...
test_that("Chapter 4 functions basically work", {
  ...
  expect_output(
    object = Wald_CI_2x2(perondi_2004),
  ...
  expect_output(
    object = Cornfield_exact_conditional_CI_2x2(lampasona_2013),
    regexp = "estimate = 5.6250 \\(95% CI 1.0226 to 31.5025\\)"
  )
  expect_output(
    object = Cornfield_midP_CI_2x2(tea),
    regexp = "estimate = 9.0000 \\(95% CI 0.3101 to 308.5568\\)"
  )
  expect_output(
    object = Fisher_exact_test_2x2(ritland_2007),
    regexp = "P = 0.06287"
  )
  expect_output(
    object = Exact_unconditional_test_2x2(tea),
    regexp = "The Suissa-Shuster exact unconditional test: P = 0.28916"
  )
  expect_output(
    object = Fisher_midP_test_2x2(ritland_2007),
    regexp = "The Fisher mid-P test \\(Fisher-Irwin\\): P = 0.04466"
  )
  expect_output(
    object = Gart_adjusted_logit_CI_2x2(ritland_2007),
    regexp = "estimate = 0.0000 \\(95% CI 0.0064 to 1.9804\\)"
  )
  expect_output(
    object = Independence_smoothed_logit_CI_2x2(lampasona_2013),
    regexp = "estimate = 5.6250 \\(95% CI 1.0206 to 23.7777\\)"
  )
  expect_output(
    object = Inv_sinh_CI_OR_2x2(lampasona_2013),
    regexp = "estimate = 5.6250 \\(95% CI 1.2472 to 25.3686\\)"
  )
  expect_output(
    object = Inv_sinh_CI_ratio_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 1.1671 to 41.9827\\)"
  )
  expect_output(
    object = Katz_log_CI_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 0.9096 to 53.8695\\)"
  )
  expect_output(
    object = Koopman_asymptotic_score_CI_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 1.2209 to 42.5757\\)"
  )
  expect_output(
    object = LR_test_2x2(tea),
    regexp = "P = 0.14798, T = 2.093 \\(df = 1\\)"
  )
  expect_output(
    object = Mee_asymptotic_score_CI_2x2(perondi_2004),
    regexp = "estimate = 0.1765 \\(95% CI 0.0284 to 0.3439\\)"
  )
  expect_output(
    object = MiettinenNurminen_asymptotic_score_CI_difference_2x2(ritland_2007),
    regexp = "estimate = -0.2083 \\(95% CI -0.3164 to -0.0056\\)"
  )
  expect_output(
    object = MiettinenNurminen_asymptotic_score_CI_OR_2x2(lampasona_2013),
    regexp = "5.6250 \\(95% CI 1.0934 to 28.9419\\)"
  )
  expect_output(
    object = MiettinenNurminen_asymptotic_score_CI_ratio_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 1.2086 to 43.0330\\)"
  )
  expect_output(
    object = MOVER_R_Wilson_CI_OR_2x2(lampasona_2013),
    regexp = "estimate = 5.6250 \\(95% CI 1.0433 to 20.5670\\)"
  )
  expect_output(
    object = MOVER_R_Wilson_CI_ratio_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 1.1537 to 41.9763\\)"
  )
  expect_output(
    object = Newcombe_hybrid_score_CI_2x2(perondi_2004),
    regexp = "estimate = 0.1765 \\(95% CI 0.0189 to 0.3404\\)"
  )
  expect_output(
    object = Pearson_chi_squared_test_2x2(tea),
    regexp = "Pearson chi-squared test: P = 0.15730, T = 2.000 \\(df = 1\\)"
  )
  expect_output(
    object = Pearson_chi_squared_test_CC_2x2(tea),
    regexp = "chi-squared test: P = 0.47950, T = 0.500 \\(df = 1\\)"
  )
  expect_output(
    object = PriceBonett_approximate_Bayes_CI_2x2(perondi_2004),
    regexp = "estimate = 7.0000 \\(95% CI 0.9205 to 36.5449\\)"
  )
  expect_output(
    object = Wald_CI_CC_2x2(perondi_2004),
    regexp = "estimate = 0.1765 \\(95% CI -0.0002 to 0.3532\\)"
  )
  expect_output(
    object = the_2x2_table_CIs_difference(ritland_2007),
    regexp = "Miettinen-Nurminen asymptotic score -0.3164 to -0.0056"
  )
  expect_output(
    object = Woolf_logit_CI_2x2(ritland_2007),
    regexp = "estimate = 0.0000 \\(95% CI 0.0000 to    Inf\\)"
  )
  expect_output(
    object = Uncorrected_asymptotic_score_CI_2x2(ritland_2007),
    regexp = "0.0000 \\(95% CI 0.0000 to 0.9532\\)"
  )
  expect_output(
    object = the_2x2_table_CIs_OR(ritland_2007),
    regexp = "inverse sinh \\(0.45, 0.25\\)     0.006 to  1.817    5.766"
  )
  expect_output(
    object = the_2x2_table_CIs_ratio(ritland_2007),
    regexp = "Price-Bonett approximate Bayes\\s+0.001 to  3.425    7.836"
  )
  expect_output(
    object = Z_unpooled_test_2x2(ritland_2007),
    regexp = "The Z-unpooled test: P = 0.00001, Z = -4.353"
  )
  expect_output(
    object = the_2x2_table_tests(ritland_2007),
