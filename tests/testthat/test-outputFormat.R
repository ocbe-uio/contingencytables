...
test_that("Output classes are the expected", {
  ...
  expect_is(Exact_cond_midP_tests_rxc(n5, printresults = FALSE), "list")
  ...
  expect_is(gamma_coefficient_rxc_bca(n, printresults = FALSE), "list")
  ...
  expect_is(Kendalls_tau_b_rxc_bca(n, printresults = FALSE), "list")
  ...
  expect_is(McNemar_exact_unconditional_test_paired_2x2(n3, printresults = FALSE), "numeric")
  ...
  expect_is(Pearson_correlation_coefficient_rxc_bca(n, printresults = FALSE), "list")
  ...
  expect_is(Spearman_correlation_coefficient_rxc_bca(n, printresults = FALSE), "list")
  ...
  expect_is(invisible(capture.output(the_rx2_table(n2))), "character")
  expect_is(invisible(capture.output(the_rxc_table(n2, nboot = 700))), "character")
...
test_that("Output names are the expected", {
  ...
  expect_named(Exact_cond_midP_tests_rxc(n5, printresults = FALSE), c("P_FFH", "midP_FFH", "P_Pearson", "midP_Pearson", "P_LR", "midP_LR", "P_KW", "midP_KW", "P_lbl", "midP_lbl", "P_JT", "midP_JT"))
  ...
  expect_named(gamma_coefficient_rxc_bca(n, printresults = FALSE), c("gamma", "L", "U"))
  ...
  expect_named(Kendalls_tau_b_rxc_bca(n, printresults = FALSE), c("tau_b", "L", "U"))
  ...
  expect_named(McNemar_exact_unconditional_test_paired_2x2(n3, printresults = FALSE), NULL)
  ...
  expect_named(Pearson_correlation_coefficient_rxc_bca(n, printresults = FALSE), rplu)
  ...
  expect_named(Spearman_correlation_coefficient_rxc_bca(n, printresults = FALSE), c("rho", "L", "U"))
  ...
  expect_named(invisible(capture.output(the_rx2_table(n2))), NULL)
  expect_named(invisible(capture.output(the_rxc_table(n2, nboot = 700))), NULL)
